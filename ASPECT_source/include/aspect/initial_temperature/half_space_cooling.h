...
#ifndef _aspect_initial_temperature_half_space_cooling_h
#define _aspect_initial_temperature_half_space_cooling_h
...
namespace aspect
{
  namespace InitialTemperature
  {
     ...
     */
    template <int dim>
    class HalfSpaceCooling : public Interface<dim>, public Utilities::AsciiDataBoundary<dim>
    {
      public:
